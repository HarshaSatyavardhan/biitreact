                ...
                <div className="flex flex-wrap justify-center">
                  <div className="flex flex-row w-full lg:w-9/12 px-4">
                    <p className="flex mb-1 text-lg leading-relaxed text-gray-800 justify-items-center hover:opacity-75 transition">
                      <p flex flex-col>
                        <Link href="/projects/firstproject">
                    ...
                    <p className="flex mb-1 text-lg leading-relaxed text-gray-800 justify-items-center hover:opacity-75 transition">
                      <p flex flex-col>
                        <Link href="#">
                          ...
                          self-assembled via affinity ligands.
                        </Link>
                        <p className="italic text-sm p-2">
                          Nature Biomedical Engineering, 2019
                        </p>
                        <p className="italic text-sm p-2">
                          Gupta N, Ansari A, Dhoke GV, Chilamari M, Sivaccumar
                          J, Kumari S, Chatterjee S, Goyal R, Dutta PK, Samarla
                          M, Mukherjee M, Sarkar A, Mandal SK, Rai V, Biswas G,
                          Sengupta A, Roy S, Roy M, Sengupta S.
                        </p>
                      </p>
                    </p>
                  </div>
